...
import com.developer.android.dev.technologia.androidapp.quickcabs.utils.rememberDeviceWidth
...
fun QuickCabGoogleMap(
    ...
    latLangBounds: LatLngBounds? = null,
    ...
    LaunchedEffect(isMapReady) {
        if(isMapReady.value){
            ...
            if(cameraPositionDefault == null && latLangBounds != null){
                cameraPositionState.animate(
